...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        #biases and weights are all initialized randomly (some number between 0 and 1):
        self.biases = [np.random.randn(y, 1) for y in sizes[1:]] # biases are vectors: 1 bias per
    ...
    def stochastic_gradient_descent(self, training_data, epochs, mini_batch_size, eta,
        ...
        Note that eta is the learning rate -- a tuning parameter in an optimization 
        algorithm that determines the step size at each iteration while moving
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        for x, y in mini_batch:
            ...
            # most of the work done by this line:
            delta_nabla_b, delta_nabla_w = self.backprop(x, y)
            nabla_b = [nb+dnb for nb, dnb in zip(nabla_b, delta_nabla_b)]
            nabla_w = [nw+dnw for nw, dnw in zip(nabla_w, delta_nabla_w)]
        
        # update weights and biases based on backprop "nudges"
